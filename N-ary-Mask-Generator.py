...
@author: Olivier-Rukundo - Modifications by orukundo@gmail.com - Olivier Rukundo Ph.D.

"""
# @original script: https://github.com/ruchikaverma-iitg/MoNuSAC/blob/master/n-ary_mask_generation.ipynb 
# Errors generated by the original script: ValueError: A linearring requires at least 4 coordinates.
# Corrections or updated made (see lines):            
...
# Additional updates: Consided using a more common format (like PNG) to automatically handle metadata more consistently with our expectations (see lines): 
...
count = 0
data_path = r'C:\Users\...\TrainingData\MoNuSAC_images_and_annotations' #Path to read data from
destination_path = r'C:\Users\...\NaryMaskTrainingData' # Path to save n-ary masks corresponding to xml files
